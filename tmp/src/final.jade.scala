...
object $_scalate_$final_jade {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    ;{
      ...
      ;{
        val Name: String = $_scalate_$_context.attribute("Name")
...
class $_scalate_$final_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$final_jade.$_scalate_$render(context)
}
