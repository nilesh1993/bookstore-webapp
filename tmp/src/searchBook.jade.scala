...
object $_scalate_$searchBook_jade {
...
class $_scalate_$searchBook_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$searchBook_jade.$_scalate_$render(context)
}
