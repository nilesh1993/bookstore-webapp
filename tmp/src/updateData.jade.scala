...
object $_scalate_$updateData_jade {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    ;{
      ...
      $_scalate_$_context << ( "<head>\n  <script type=\"text/javascript\" src=\"https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js\"></script>\n</head>\n<form action=\"searchData\" method=\"post\" id=\"updateForm\">\n  <select name=\"mydropdown\">\n    <option value=\"bookId\">bookId</option>\n    <option value=\"bookName\">bookName</option>\n    <option value=\"bookAuthor\">bookAuthor</option>\n    <input type=\"text\" name=\"BookId\"/>\n    <br/>\n  </select>\n  <input type=\"button\" id=\"searchbttn\" class=\"searchbtn\" value=\"search\">\n    <div id=\"serchData\"></div>\n  </input>\n</form>\n<form id=\"updateFormm\">\n  <h3>select the content u want to update</h3>\n  <select name=\"dropdown\">\n    <option value=\"bookId\">bookId</option>\n    <option value=\"bookName\">bookName</option>\n    <option value=\"bookAuthor\">bookAuthor</option>\n    <br/>\n    old\n    <input type=\"text\" name=\"old\"/>\n    new\n    <input type=\"text\" name=\"new\"/>\n  </select>\n  <input type=\"button\" id=\"updatebtn\" class=\"updatebtn\" value=\"update\"/>\n  <!-- /button(id=\"searchbutton\" value=\"button\") -->\n  <!-- /\t|Search -->\n</form>\n" );
    }
  }
}


class $_scalate_$updateData_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$updateData_jade.$_scalate_$render(context)
}
